...
function NewClient() {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            setMessage(`Файл успешно загружен: ${response.data.message || 'Успех'}`);
                    ...
                    <div className='new-client__calculate'>
                        ...
                        {responseData && (
                            <div className="response-block">
                                ...
                                {responseData.string ? (
                                    <div className="response-text">{responseData.string}</div>
                                ) : responseData.detail ? (
                                    <div className="response-detail">
                                        <p><strong>Tags:</strong> {responseData.detail[0]?.tag?.join(', ')}</p>
                                        <p><strong>Type:</strong> {responseData.detail[0]?.type}</p>
                                    </div>
                                ) : (
